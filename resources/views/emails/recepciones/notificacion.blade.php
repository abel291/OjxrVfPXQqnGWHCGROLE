...
<head>
    ...
    <title>Documentos en Oficina</title>
                    ...
                    <tr>
                        <td class="content-wrap">
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <label>{{$recepcion->user->first_name}} {{$recepcion->user->last_name}}</label> Por este medio se le notifica que los siguiente documentos ya estan en la oficina correspondiente
