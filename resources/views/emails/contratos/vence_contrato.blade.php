...
<head>
    ...
    <title>El contrato venció</title>
                    ...
                    <table class="main" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="alert alert-good">
                                El contrato {{$contrato->n_contrato}} {{$contrato->consultoria}} expira hoy.
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="content-block">
                                            El contrato a cargo {{$user->sexo?' del consultor':' de la consultora'}} <b>{{$user->first_name}} {{$user->last_name}}</b> expira hoy <b>{{ date('Y-m-d', strtotime($contrato->fecha_fin)) }}</b> y su estado actual es                                         
